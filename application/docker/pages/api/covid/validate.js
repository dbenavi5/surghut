...
module.exports = async (req, res) => {
  ...
  UPDATE County C
  SET
  C.covid_case = (SELECT C.nb_case FROM Covid C WHERE C.upload_time=${req.body.upload_time}),
  C.covid_death = (SELECT C.nb_death FROM Covid C WHERE C.upload_time=${req.body.upload_time})
